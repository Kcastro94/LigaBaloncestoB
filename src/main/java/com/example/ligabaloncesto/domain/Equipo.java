...
public class Equipo implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Jugador> equipoJugadors = new HashSet<>();
    ...
    public Set<Jugador> getEquipoJugadors() {
        return equipoJugadors;
    }

    public void setEquipoJugadors(Set<Jugador> jugadors) {
        this.equipoJugadors = jugadors;
    }
