            ...
            .state('jugador.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {nombre: null, fechaNacimiento: null, asistenciasTotales: null, rebotesTotales: null, canastasTotales: null, faltasTotales: null, posicionCampo: null, id: null};
                            }
                        }
