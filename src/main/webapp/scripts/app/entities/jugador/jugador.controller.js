...
angular.module('ligabaloncestoApp')
    .controller('JugadorController', function ($scope, Jugador, ParseLinks) {
        ...
        $scope.clear = function () {
            $scope.jugador = {nombre: null, fechaNacimiento: null, asistenciasTotales: null, rebotesTotales: null, canastasTotales: null, faltasTotales: null, posicionCampo: null, id: null};
        };
    });
